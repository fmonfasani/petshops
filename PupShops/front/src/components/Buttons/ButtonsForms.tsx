...
export const ButtonForms: React.FC<IButtonProps> = ({
  text,
  onClick,
  type = "submit",
  disabled = false,
...
export const ButtonRedirectUser: React.FC<IButtonProps> = ({
  text,
  onClick,
  type = "submit",
  disabled = false,
...
export const ButtonAdvert: React.FC<IButtonProps> = ({
  text,
  onClick,
  type = "button",
}) => {
...
export const ButtonDeleteUser: React.FC<IButtonPropsDelete> = ({
  onConfirm,
  onCancel,
}) => {
  return (
