...
import {
  fetchAppointments,
  deleteAppointment,
} from "@/utils/fetchAdminAppointments";
    ...
    <div className="max-w-4xl mx-auto mt-20 p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="flex justify-between text-gray-600 mb-4">
        ...
        >
          ...
          <option value="reserved" className="text-gray-600">
            Reservados
          </option>
          <option value="canceled" className="text-gray-600">
            Cancelados
          </option>
        </select>
          ...
          >
            <div className="flex flex-col">
              <div>
                ...
                <p
                  className={`text-sm font-bold ${appointment.status === "reserved" ? "text-teal-700" : appointment.status === "canceled" ? "text-red-600" : "text-gray-600"}`}
                >
                  <strong>Estado:</strong> {appointment.status}
                </p>
                <div className="text-lg text-teal-700 mt-4 pt-1">
